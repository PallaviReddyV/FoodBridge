...
const Ngoregister = () => {
  ...
  const handleRegister = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:8000/Ngoregister', {
        yourName,
        ngoEmail,
        ngoName,
        ngoAddress,
                    ...
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="email" value={ngoEmail} onChange={(e) => setNgoEmail(e.target.value)} id="form3Example3c" className="form-control" />
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="text" value={ngoName} onChange={(e) => setNgoName(e.target.value)} id="form3Example1c" className="form-control" />
                            <label className="form-label" htmlFor="form3Example1c">NGO Name</label>
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="text" value={ngoAddress} onChange={(e) => setNgoAddress(e.target.value)} id="form3Example1c" className="form-control" />
                            <label className="form-label" htmlFor="form3Example1c">NGO Address</label>
                          </div>
                        </div>
